...
public class BucketDemo {
    ...
    public static void CreateBucketDemo() {
        ...
        COSCredentials cred = new BasicCOSCredentials("1259672777","AKIDMXS7VcS1KL6ZlgKgmb9PO7Y7PRCgtpVu", "8zauwhCSRActtc4KJ1SbT4ORDhuqWv3u");
        // 2 设置bucket的区域, COS地域的简称请参照 https://www.qcloud.com/document/product/436/6224
        ClientConfig clientConfig = new ClientConfig(new Region("https://littlenine-1259672777.cos.ap-nanjing.myqcloud.com"));
        // 3 生成cos客户端
        COSClient cosclient = new COSClient(cred, clientConfig);
        // bucket名称, 需包含appid
        String bucketName = "littlenine-1259672777";
